...
## HOUSE PHILOSOPHY
Standing Reserve (written 2026-08-12, first run of CYCLE 1).
...
## CONSUMED
Photographs that have appeared in a shipped asset this cycle. 7 of 43 spent, 36 remain.
...
- Greek slots 02 and 05 are now used. Pick an unused pair.
- The story archetype `plate in negative space` and hook `use case moment` are used. Rotate.
- Story language was EN. Next story should be GR.
- Fonts are not bundled in this sandbox. `build.py` downloads them from Google Fonts into
  /home/user/fonts. Verified full Greek cmap coverage: Alegreya, Comfortaa, Fira Sans,
  Fira Sans Condensed, IBM Plex Sans, Inter, Manrope, Noto Sans, Roboto Condensed,
  Roboto Mono, Source Serif 4, Ubuntu. No Greek: Anton, Archivo, Barlow, Barlow Condensed,
  Bodoni Moda, Cormorant, Josefin Sans, Jost, Montserrat, Nunito Sans, Oswald,
